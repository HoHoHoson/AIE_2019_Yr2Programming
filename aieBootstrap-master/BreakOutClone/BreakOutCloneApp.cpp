...
BreakOutCloneApp::BreakOutCloneApp() {
...
void BreakOutCloneApp::shutdown() {

	delete m_font;
	delete m_2dRenderer;
}

void BreakOutCloneApp::update(float deltaTime) {
